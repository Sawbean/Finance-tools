...
export default function StockAverageCalculator() {
  ...
  return (
    <>
      <Head>
        <title>Stock Average Calculator | Break-even Price Tool | ToolFinance</title>
        <meta 
          name="description" 
          content="Calculate the average cost of your stocks when buying at multiple price points. Determine your break-even price instantly." 
        />
      </Head>
